				...
				<div class="col-lg-12">
					<div class="main-heading">
						<div class="page-prog">
							...
							<p>Blog</p>
							<span><i class="fa-solid fa-angle-right"></i></span>
							<p class="bold">Blog Without Sidebar</p>
						</div>
					...
					<div class="row align-items-center">
								...
								<div class="heading1">
									<div class="social-area">
										<div class="author-area">
											...
											<div class="date">
												<span><img src="{{ asset('assets/img/icons/date1.svg') }}" alt="vexon" /> Oct 26, 2024 </span>
											</div>
										</div>
						...
						<div class="col-lg-8 m-auto">
							<div class="thumbnail image-anime _relative mt-20">
								<img src="{{ asset('assets/img/blog/blog-details-image1.png') }}" alt="vexon" />
							</div>
						</div>
					</div>
				</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="image _relative image-anime mt-40">
											<img class="w-full" src="{{ asset('assets/img/blog/blog-details-image2.png') }}" alt="vexon" />
										</div>
									</div>
									<div class="col-md-6">
										<div class="image _relative image-anime mt-40">
											<img class="w-full" src="{{ asset('assets/img/blog/blog-details-image3.png') }}" alt="vexon" />
										</div>
									</div>
								</div>
							</div>
